    ...
    async with db_helper.session_factory() as session:
        for league in events:
            ...
            for match_event in league_events:
                home_name, away_name, start_ts, period, _, _, scores_dict, *_ = match_event
                ...
                stmt = select(Match.id) \
                                        ...
                                        .filter(
                                            ...
                                            cast(Match.start_time, Date) == timestamp_to_datetime(start_ts).date(),
                ...
                for idx, score in scores_dict.items():
                    ...
                    insert_stmt = insert(MatchResult).values(
                        match_id=match_id,
                        period=int(idx),
