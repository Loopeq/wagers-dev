...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        None, "bet", "match", ["match_id"], ["id"], ondelete="CASCADE"
    )
    ...
    op.create_foreign_key(
        None, "bet_change", "bet", ["old_bet_id"], ["id"], ondelete="CASCADE"
    )
    op.create_foreign_key(
        None, "bet_change", "bet", ["new_bet_id"], ["id"], ondelete="CASCADE"
    )
    op.drop_constraint("match_member_match_id_fkey", "match_member", type_="foreignkey")
    op.create_foreign_key(
        None, "match_member", "match", ["match_id"], ["id"], ondelete="CASCADE"
    )
...
def downgrade() -> None:
    ...
    op.create_foreign_key(
        "match_member_match_id_fkey", "match_member", "match", ["match_id"], ["id"]
    )
    op.drop_constraint(None, "bet_change", type_="foreignkey")
    op.drop_constraint(None, "bet_change", type_="foreignkey")
    op.create_foreign_key(
        "bet_change_old_bet_id_fkey", "bet_change", "bet", ["old_bet_id"], ["id"]
    )
    op.create_foreign_key(
        "bet_change_new_bet_id_fkey", "bet_change", "bet", ["new_bet_id"], ["id"]
    )
