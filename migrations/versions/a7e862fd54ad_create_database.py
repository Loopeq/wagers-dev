...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum("total", "spread", "team_total", name="bettypeenum"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column("name", sa.String(), nullable=False),
        sa.Column(
            "status", sa.Enum("win", "lose", name="matchresultenum"), nullable=True
        ),
        sa.Column(
            "side", sa.Enum("home", "away", name="matchsideenum"), nullable=False
        ),
        sa.ForeignKeyConstraint(
            ["match_id"],
            ["match.id"],
